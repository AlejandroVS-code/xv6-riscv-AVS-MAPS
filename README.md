...
docker build -t xv6-avs .

# 3. Ejecutar xv6
docker run -it --privileged xv6-avs
```

**Nota:** el flag `--privileged` es obligatorio para que QEMU pueda emular hardware RISC-V dentro del contenedor.
...
| `feature/metrics` | Métricas de rendimiento scheduler y memoria |
